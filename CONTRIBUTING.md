# Contributing to the ProjectWise app
...
* Search [GitHub](https://github.com/Projectwise/projectwise-app/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `projectwise-app:master`.
